...
Display the posterior inclusion probability (PIP) of each beta with a selection threshold of $0.75$ for the SS based model.
...
Display the 95% ETI CrI of each beta for the HS based model. Within the plot, along the x-axis are the names of the features and above are their respective groups.
